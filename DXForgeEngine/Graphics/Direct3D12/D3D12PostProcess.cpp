...
namespace dxforge::graphics::d3d12::fx
{
	namespace
	{
		...
		ID3D12RootSignature* fx_root_sig{ nullptr };	// ルートシグネチャ
		ID3D12PipelineState* fx_pso{ nullptr };		// パイプラインステート

		/// @brief ポストプロセスのPSOとルートシグネチャを作成
		/// @return 作成に成功したらtrue
