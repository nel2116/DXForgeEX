...
namespace dxforge::input
{
	namespace
	{
		...
		void set_modifier_inputs(u8 virtual_key, input_code::code code, modifier_flags::flags flags)
		{
		...
		void set_modifier_inputs(input_code::code code)
		{
			...
			{
				set_modifier_inputs(VK_LSHIFT, input_code::key_left_shift, modifier_flags::left_shift);
				set_modifier_inputs(VK_RSHIFT, input_code::key_right_shift, modifier_flags::right_shift);
			}
			else if (code == input_code::key_control)
			{
				set_modifier_inputs(VK_LCONTROL, input_code::key_left_control, modifier_flags::left_control);
				set_modifier_inputs(VK_RCONTROL, input_code::key_right_control, modifier_flags::right_control);
			}
			else if (code == input_code::key_alt)
			{
				set_modifier_inputs(VK_LMENU, input_code::key_left_alt, modifier_flags::left_alt);
				set_modifier_inputs(VK_RMENU, input_code::key_right_alt, modifier_flags::right_alt);
			}
		}
