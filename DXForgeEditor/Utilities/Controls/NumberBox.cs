...
namespace DXForgeEditor.Utilities.Controls
{
    ...
    public class NumberBox : Control
    {
        ...
        public override void OnApplyTemplate()
        {
            ...
            {
                textBlock.MouseLeftButtonDown += OnTextBlok_Mouse_LBD;
                textBlock.MouseLeftButtonUp += OnTextBlok_Mouse_LBU;
                textBlock.MouseMove += OnTextBlok_Mouse_Move;
            }
        }

        // マウスの左ボタンが押されたときの処理
        private void OnTextBlok_Mouse_LBD(object sender, MouseButtonEventArgs e)
        {
            // 元の値を保持
        ...
        private void OnTextBlok_Mouse_Move(object sender, MouseEventArgs e)
        {
            if (_captured)
            {
